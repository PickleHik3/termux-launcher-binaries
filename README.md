...
| `bin/dawn-aarch64` | dawn `0.1.3+0e958747` + `recipes/0001`–`0004-dawn-*.patch` (clipboard, AI chat, editing, frame dedup), for the `com.termux` prefix | [andrewmd5/dawn `0e958747`](https://github.com/andrewmd5/dawn/tree/0e9587477463ece157ef7eea66c9e34bc5c7737a) |
...
two binaries are in `recipes/` and apply cleanly, in order, to `0e958747`:
...
for p in 0001-dawn-termux-clipboard 0002-dawn-openai-bridge 0003-dawn-edit-tools \
         0004-dawn-skip-unchanged-frames; do git apply /path/to/recipes/$p.patch; done
```
...
- dawn — MIT, `licenses/dawn-MIT.txt`, modified by `recipes/0001`–`0004-dawn-*.patch`
