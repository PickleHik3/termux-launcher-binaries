...
The `io.vaj.tl` build was produced 2026-09-01 with NDK `29.0.14206865` against a sysroot from that
edition's own repository (`https://repo.pathayam.xyz`); the three `com.termux` binaries were built
2026-08-16 with NDK `27.2.12479018`.
